...
In rodents, gamma oscillations reflect the activity of local networks, namely the interaction between pyramidal neurons and interneurons in rodents (REF). They are tightly modulated by theta oscillations (REF), and this theta-gamma \g{pac} is crucial for memory acquisition and recall (REFS). Likewise, human hippocampal spiking correlates with local gamma-band (60 – 160 Hz) activity (see Appendix~\ref{apdx:spike2Gamma} and REFS). We then tested whether gamma-band activity was coupled to hippocampal 2-Hz. First, by measuring the average of gamma activity and population firing rate triggered by individual oscillatory cycles of 1-, 2- and 6-Hz oscillations, we showed clear entrainment of gamma activity at 2-Hz (Fig.~\ref{hpc-trigAvgs}). 
...
% @@@ EXPLAIN ANTERO-POSTERIOR

% @@@ FIG ANTERO-POSTERIOR
...
Conclusion: 2-Hz is fast enough to organize neuronal and gamma activity in the hippocampus. This result provides additional evidence that the 2-Hz oscillations is locally generated and not picked up by volume conduction (see Chapter XXX). 
