...
Intro sentence: We next investigated whether these 2-Hz bursts were valid oscillations...
...
\subsubsubsection{Local reference reduces detection of slow oscillations}
...
\captionof{figure}{
    \label{fig:localRef}
    \textbf{Local reference reduces detection of slow oscillations}
