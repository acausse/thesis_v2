...
\captionof{figure}{
    ...
    \textbf{Hippocampal \gs{erp} deflection is modulated by mnemomic engagement}
    (\textbf{A}) Group-level average hippocampal \gsp{lfp}s showing contrasts between viewing and learning or recall sessions. \gs{erp} have a greater deflection after the onset of learning and recalling photographs than after viewing photographs.
    (\textbf{B}) Group-level average hippocampal \gsp{lfp}s showing contrasts between best and worst recalled associations during memory recall. Data were analyzed with cluster-based permutation tests; ***P < 0.001, **P < 0.01, *P < 0.05; n.s., not significant.
}
